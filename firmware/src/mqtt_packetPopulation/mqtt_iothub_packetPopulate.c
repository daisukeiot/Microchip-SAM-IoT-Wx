...
bool MQTT_CLIENT_pnp_subscribe()
{
    ...
    imqtt_publishReceiveCallBackTable[0].topic = AZ_IOT_PNP_CLIENT_COMMANDS_SUBSCRIBE_TOPIC;
    imqtt_publishReceiveCallBackTable[0].mqttHandlePublishDataCallBack = receivedFromCloud_commands;
    imqtt_publishReceiveCallBackTable[1].topic = AZ_IOT_PNP_CLIENT_PROPERTY_PATCH_SUBSCRIBE_TOPIC;
    imqtt_publishReceiveCallBackTable[1].mqttHandlePublishDataCallBack = receivedFromCloud_patch;
    imqtt_publishReceiveCallBackTable[2].topic = AZ_IOT_PNP_CLIENT_PROPERTY_RESPONSE_SUBSCRIBE_TOPIC;
